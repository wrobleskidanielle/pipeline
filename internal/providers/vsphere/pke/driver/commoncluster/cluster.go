...
func (a *VspherePkeCluster) GetK8sIpv4Cidrs() (*pkgCluster.Ipv4Cidrs, error) {
...
func (a *VspherePkeCluster) ListNodeNames() (nodeNames pkgCommon.NodeNames, err error) {
...
func (a *VspherePkeCluster) GetSecurityScan() bool {
	return a.model.SecurityScan
}

func (a *VspherePkeCluster) SetSecurityScan(scan bool) {
	a.model.SecurityScan = scan
	a.store.SetFeature(a.model.ID, "SecurityScan", scan) // nolint: errcheck
}

func (a *VspherePkeCluster) GetLogging() bool {
	return a.model.Logging
}

func (a *VspherePkeCluster) SetLogging(l bool) {
	a.model.Logging = l
	a.store.SetFeature(a.model.ID, "Logging", l) // nolint: errcheck
}

func (a *VspherePkeCluster) GetMonitoring() bool {
	return a.model.Monitoring
}

func (a *VspherePkeCluster) SetMonitoring(m bool) {
